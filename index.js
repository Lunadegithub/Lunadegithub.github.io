        ...
        series: [
          {
            ...
            type: 'bar',
            barWidth: '35%',
            data: [3000,5000, 6000, 10000, 11000],
            itemStyle:{
                barBorderRadius:5
            }
          }
...
(function(){
  //声明颜色函数
  var myColor=["#F57474","#56D0E3","#F88448","#8878F6","#DBA893"];
  //1.实例化对象
...
(function(){
  ...
  },
  {
    ...
    data: [
      ...
      [21, 82, 64, 43, 60, 19, 34, 143, 131, 165, 123, 178]
    ]
  }
];
  //1.实例化对象
